        ...
        return FighterProfileResponse.builder()
                ...
                .club(Optional.ofNullable(profile.getClub())
                        .map(club -> ClubResponse.builder()
                                ...
                                .ownerId(Optional.ofNullable(club.getOwner())
                                        .map(FighterProfile::getId)
                                        .orElse(null))
                                .ownerName(Optional.ofNullable(club.getOwner())
                                        .map(FighterProfile::getFullName)
                                        .orElse(null))
                                .ownerUsername(Optional.ofNullable(club.getOwner())
                                        .map(FighterProfile::getUser)
                                        .map(User::getNickname)
                                        .orElse(null))
                                .ownerEmail(Optional.ofNullable(club.getOwner())
                                        .map(FighterProfile::getUser)
                                        .map(User::getEmail)
                                        .orElse(null))
                                .ownerProfilePicture(Optional.ofNullable(club.getOwner())
